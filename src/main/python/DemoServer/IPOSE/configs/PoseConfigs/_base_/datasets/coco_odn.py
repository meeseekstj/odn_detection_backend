dataset_info = dict(
    ...
    keypoint_info={
        ...
        0:
        dict(name='0101',id=0,color=[255, 128, 0],type='upper',swap=''),
        1:
        dict(name='0102',id=1,color=[255, 128, 0],type='upper',swap=''),
        2:
        dict(name='0103',id=2,color=[255, 128, 0],type='upper',swap=''),
        3:
        dict(name='0104',id=3,color=[255, 128, 0],type='upper',swap=''),
        4:
        dict(name='0105',id=4,color=[255, 128, 0],type='upper',swap=''),
        5:
        dict(name='0106',id=5,color=[255, 128, 0],type='upper',swap=''),
        6:
        dict(name='0107',id=6,color=[255, 128, 0],type='upper',swap=''),
        7:
        dict(name='0108',id=7,color=[255, 128, 0],type='upper',swap=''),
        8:
        dict(name='0109',id=8,color=[255, 128, 0],type='upper',swap=''),
        9:
        dict(name='0110',id=9,color=[255, 128, 0],type='upper',swap=''),
        10:
        dict(name='0111',id=10,color=[255, 128, 0],type='upper',swap='')
    ...
    skeleton_info={
        ...
        0:
        dict(link=('0101', '0102'), id=0, color=[51, 153, 255]),
        1:
        dict(link=('0102', '0103'), id=1, color=[51, 153, 255]),
        2:
        dict(link=('0103', '0104'), id=2, color=[51, 153, 255]),
        3:
        dict(link=('0104', '0105'), id=3, color=[51, 153, 255]),
        4:
        dict(link=('0105', '0106'), id=4, color=[51, 153, 255]),
        5:
        dict(link=('0106', '0107'), id=5, color=[51, 153, 255]),
        6:
        dict(link=('0107', '0108'), id=6, color=[51, 153, 255]),
        7:
        dict(link=('0108', '0109'), id=7, color=[51, 153, 255]),
        8:
        dict(link=('0109', '0110'), id=8, color=[51, 153, 255]),
        9:
        dict(link=('0110', '0111'), id=9, color=[51, 153, 255])
    },
    joint_weights=[
        1.2, 1.1, 1., 1.2, 1.2, 1., 1., 1., 1.2, 1.1, 1.1
