...
def GetDemoConfigsFromConfigsFile(DemoConfigsFilePath: str) -> (list, dict):
    """解析项目的yaml配置文件
...
def LoadPoseModel(DemoConfigs: dict) -> (str, any):
    """加载模型
...
def LoadDatasetConfigs(PoseModel: any) -> (str, DatasetInfo):
